            ...
            >
              ...
              <section className="space-y-12">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  <Button size="lg" className="h-18 px-12 text-lg !rounded-2xl shadow-2xl shadow-sun-primary/20" onClick={() => handleSetView('signup')}>
                    Get Started Free
                  </Button>
                  <Button variant="secondary" size="lg" className="h-18 px-12 text-lg !rounded-2xl border border-sun-border bg-sun-surface/50" onClick={() => handleSetView('login')}>
                    Sign In
                  </Button>
                </div>
              </section>

              {/* The "Wisdom Gap" Section */}
              <section className="space-y-16">
                <div className="space-y-4">
                  <h2 className="text-3xl md:text-5xl font-display font-bold tracking-tight">The Wisdom Gap</h2>
                  <p className="text-sun-text-muted max-w-xl mx-auto">Traditional social media was built for distraction. We were built for <span className="text-sun-text-main font-bold italic underline decoration-sun-primary">destination</span>.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
                  {[
                    { platform: "TikTok", flaw: "Dopamine & Distraction", solution: "Intentional Learning Nodes", color: "text-red-400" },
                    { platform: "Instagram", flaw: "Vanity & Ego", solution: "Value-Driven Credibility", color: "text-pink-400" },
                    { platform: "Facebook", flaw: "Noise & Toxicity", solution: "Structured Intelligence Feed", color: "text-blue-400" },
                    { platform: "Snapchat", flaw: "Ephemeral Content", solution: "Compounding Knowledge Base", color: "text-yellow-400" }
                  ].map((item, i) => (
                    <div key={i} className="glass-card p-8 rounded-[2rem] space-y-4 border-l-4 border-sun-primary hover:scale-[1.02] transition-transform">
                      <p className={`text-xs font-black uppercase tracking-[0.2em] ${item.color}`}>{item.platform}</p>
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-2 text-sun-text-main font-bold leading-tight">
                          <CheckCircle2 size={16} className="text-sun-primary shrink-0" /> {item.solution}
                        </div>
                      </div>
                    </div>
                  ))}
              ...
              <section className="space-y-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-left">
                  <div className="space-y-8">
                    <Badge variant="primary" className="px-4 py-1.5 uppercase tracking-widest text-[10px]">Premium Features</Badge>
                    <h2 className="text-4xl md:text-6xl font-display font-bold leading-tight">Designed for <br/><span className="text-sun-primary">High-Performance</span> Minds.</h2>
                    <p className="text-sun-text-muted text-lg leading-relaxed">
                      We didn't just build another app. We built a cognitive framework. Connect with experts, attend live scaling sessions, and turn your feed into a personalized university.
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      {[
                        { icon: <Zap size={20}/>, title: "Hyper-Growth", desc: "Short-form lessons tailored to your learning goals." },
                        { icon: <BookOpen size={20}/>, title: "Scaling Rooms", desc: "Interactive sessions with global industry leaders." },
                        { icon: <Users size={20}/>, title: "Elite Circles", desc: "Private networking nodes for focused collaboration." },
                        { icon: <Award size={20}/>, title: "Verified Skills", desc: "Proof of proficiency that builds real-world value." }
                      ].map((feat, i) => (
                        <div key={i} className="space-y-2 group">
                          ...
                          <p className="text-xs text-sun-text-muted leading-relaxed">{feat.desc}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                  <div className="relative group">
                    <div className="absolute -inset-4 bg-sun-primary/10 rounded-[3rem] blur-2xl group-hover:bg-sun-primary/20 transition-colors"></div>
                    <div className="relative glass-card aspect-square rounded-[3rem] overflow-hidden flex items-center justify-center border-sun-border">
                      <div className="p-12 space-y-6 text-center">
                         ...
                         <h3 className="text-2xl font-display font-bold">Your Success, <br/>Quantified.</h3>
                         <p className="text-sm text-sun-text-muted">Our AI tracks your knowledge compound interest daily.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <section className="space-y-16">
                <div className="space-y-4">
                  <h2 className="text-3xl md:text-5xl font-display font-bold tracking-tight">Voices of the Network</h2>
                  <p className="text-sun-text-muted">Thousands of creators and students have already made the switch.</p>
                </div>
                  ...
                  {[
                    ...
                    <div key={i} className="glass-card p-8 rounded-[2.5rem] relative space-y-6">
                      ...
                      <div className="flex items-center gap-4">
                        <img src={t.img} className="w-12 h-12 rounded-2xl object-cover border-2 border-sun-primary/20" alt={t.name} />
                        <div>
                          <p className="font-bold text-sun-text-main">{t.name}</p>
                          <p className="text-xs text-sun-primary uppercase tracking-widest font-black">{t.role}</p>
                        </div>
                      </div>
                    </div>
                  ))}
              ...
              <section className="py-24 relative overflow-hidden rounded-[4rem] border border-sun-primary/20 bg-gradient-to-br from-sun-primary/10 to-sun-secondary/10">
                <div className="relative z-10 space-y-10 px-8 scale-110 md:scale-125">
                  <div className="space-y-4">
                    <h2 className="text-4xl md:text-6xl font-display font-black tracking-tighter leading-none">READY TO <br/><span className="text-sun-primary italic">SCALE?</span></h2>
                    <p className="text-sun-text-muted text-sm md:text-base max-w-sm mx-auto font-medium">Join 1M+ experts building the future of learning.</p>
                  </div>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <Button size="lg" className="h-16 px-12 text-lg !rounded-2xl shadow-2xl shadow-sun-primary/20" onClick={() => handleSetView('signup')}>
                      Start My Journey
                    </Button>
                    <Button variant="outline" size="lg" className="h-16 px-12 text-lg !rounded-2xl" onClick={() => handleSetView('login')}>
                      Login
                    </Button>
                  </div>
                </div>
                
                {/* Background effects for the banner */}
                <div className="absolute top-0 right-0 w-64 h-64 bg-sun-primary/20 blur-[100px] rounded-full"></div>
                <div className="absolute bottom-0 left-0 w-64 h-64 bg-sun-secondary/20 blur-[100px] rounded-full"></div>
              </section>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-sun-border opacity-50 pt-16">
                {[
                  ...
                  <div key={i} className="space-y-1">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-sun-text-muted">{stat.label}</p>
                  </div>
                ))}
              </div>
            </motion.div>
          ...
          {view === 'login' && (
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-sun-text-muted text-sm leading-relaxed">Enter your credentials to access your personal feed.</p>
              </div>
              ...
              <div className="relative">
                <div className="absolute inset-0 flex items-center text-sun-border">
                  <div className="w-full border-t border-sun-border"></div>
                </div>
                <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-bold">
                  <span className="bg-sun-surface px-4 text-sun-text-muted">Or continue with</span>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-4">
                <Button variant="secondary" className="w-full !rounded-2xl" icon={<Chrome size={18} />}>Google</Button>
                <Button variant="secondary" className="w-full !rounded-2xl" icon={<Apple size={18} />}>Apple</Button>
              </div>
          ...
          {view === 'signup' && (
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-sun-text-muted text-sm leading-relaxed">Join a global community of experts and learners.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-2 px-1">
                  ...
                  <p className="text-[10px] text-sun-text-muted font-medium">
                    I agree to the <span className="text-sun-text-main hover:underline cursor-pointer">Terms of Service</span> and <span className="text-sun-text-main hover:underline cursor-pointer">Privacy Policy</span>.
                  </p>
                </div>
              </div>
          ...
          {view === 'forgot-password' && (
            ...
            >
              ...
              <div className="space-y-2 text-center pt-8">
                ...
                <p className="text-sun-text-muted text-sm leading-relaxed">Enter your email and we'll send you a link to recover your account.</p>
              </div>
          ...
          {view === 'otp' && (
            ...
            >
              ...
              <div className="space-y-2 text-center pt-8">
                ...
                <p className="text-sun-text-muted text-sm leading-relaxed">We've sent a code to your registered node address.</p>
              </div>
          ...
          {view === 'recovery' && (
            ...
            >
              ...
              <div className="space-y-2 text-center pt-8">
                ...
                <p className="text-sun-text-muted text-sm leading-relaxed">Secure your account with a strong new access key.</p>
              </div>
